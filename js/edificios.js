function addEdificiosCapa() {
    ...
    map.addSource("edificios_source", {
        "type": "vector",
        "url": "mapbox://azubarco.5zec1umo"  // Nuestor ID Tileset
    ...
    "source-layer": "Construcciones-69yua7", // Nuestro nombre Tileset
    "maxzoom": 21,
    "minzoom": 15,
...
},"road-label");     // fin addLayer capa texto "water-name-lakeline-platja", "road-label" //se coloca los edificios antes de los nombres de las calles
...
function addPopupToMapEdificios(nombreCapa) {
    ...
    map.on('click', nombreCapa, function (e) {
      ...
      for (key in e.features[0].properties) {
        if (key == "numberOfFloorsAboveGround") {//key recorre los nombre de campos
